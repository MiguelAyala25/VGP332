...
void Miner::Initialize()
{
	...
	ChangeStates(MinerState::GoHomeAndSleeptUntillRested);
}
...
void Miner::ChangeStates(MinerState newState)
{
...
void Miner::DebugUI()
{
	...
	ImGui::Text("Status: Bank[%d] Gold[%d] Thirst[%d] Fatigue[%d]", mMoneyInBank, mGoldCarried, mThirst, mFatigue);
...
void Miner::IncreaseGoldCarried(int amount)
{
	mGoldCarried += amount;
}
